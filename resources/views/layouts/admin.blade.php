<!DOCTYPE html>
    ...
    <!-- /.navbar -->
       ...
       <footer class="main-footer">
        <strong>Proyecto Software - 2021 </strong>
        <div class="float-right d-none d-sm-inline-block">
         <img src="{{asset('images/vendor/admin-lte/plugins/flag-icon-css/flags/4x3/bo.svg')}}" alt="AdminLTE Logo" height="20" style="opacity: .8">
        </div>
       </footer>
